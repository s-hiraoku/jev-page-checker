...
- Settings でチェックリスト全文を確認し、全体を承認してから Audit する
- Report で質問ごとと、Jev に送った文を見直す。過去の Audit は History で見る
...
- **storage:** API キー、チェックリスト承認、History を端末内に保存するため。
