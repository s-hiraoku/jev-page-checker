...
- `side-questions` lists the nine verdict labels in site then body groups, with a verdict chip each. Cite choices are not their own rows. The pass `主張の根拠` row includes the page sentence with `12 September`.
